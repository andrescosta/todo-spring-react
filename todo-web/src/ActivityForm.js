...
export default function ActivityForm({toggleModal}) {
    ...
    async function  onSubmit(event) {
        ...
        let newobj = { name: entries.name, description: entries.description, tags, media: [media] };
    ...
    return <>
        <form className="w3-container w3-card-4 w3-light-grey" onSubmit={(e) => onSubmit(e)}>
            <h6><i className="fa fa-address-book-o"> </i></h6>

            <p><label>Type</label>
                <select className="w3-select w3-border" name="type" defaultValue="option">
            ...
            <p><label>Description</label>
                <input className="w3-input w3-border" name="description" type="text" />
            </p>
            <p><label>Link</label>
            ...
            <p>
                <button className="w3-btn w3-dark-grey">
                    Add</button>
            </p>
        </form>
    </>
